...
values
  ('role-admin', 'AbilityVua_Admin', 'AbilityVua Admin', 'Full system access â€” all windows and processes', true),
  ('role-board', 'Board_Member', 'Board Member', 'Governance oversight â€” read-focused access', true),
  ('role-ceo', 'Chief_Executive_Officer', 'CEO', 'Chief executive â€” full operational leadership', true),
  ...
  ('role-team-leader', 'Team_Leader', 'Team Leader', 'Site or team leadership â€” org structure and frontline oversight', true),
  ('role-support-worker', 'Support_Worker', 'Support Worker', 'Frontline staff â€” assigned tasks, clients, incidents, and rostered locations', true),
...
values
  ...
  ('user-michael', 'MichaelSmith', 'michael.smith@abilityerp.local', 'Michael', 'Smith', '', true, 'emp-michael', 'Operations executive â€” accountable manager testing'),
