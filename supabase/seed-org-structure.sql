...
insert into public.org_position (
  ...
  ('pos-coordinator', 'Support Coordinator', 'role-coordinator', 'Client services', 'Client services', 'loc-adelaide-hub', 'pos-gm-ops', 10, 'filled', 'Adelaide HQ', 'CC-CLIENT', 'emp-isla'),
  ('pos-intake', 'Intake Officer', 'role-intake', 'Intake', 'Intake', 'loc-adelaide-hub', 'pos-gm-ops', 20, 'filled', 'Adelaide HQ', 'CC-INTAKE', 'emp-gabriela'),
  ('pos-plan-dev', 'Plan Developer', 'role-coordinator', 'Client services', 'Client services', 'loc-adelaide-hub', 'pos-gm-ops', 30, 'filled', 'Adelaide HQ', 'CC-CLIENT', 'emp-rose'),
