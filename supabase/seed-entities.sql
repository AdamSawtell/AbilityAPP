...
values
  ('1000025', '1000025', '2022-12-05', '2023-05-22', '1_Initial Enquiry', 'Samuel', 'Ryan', 'NDIS - National Disability Insurance Scheme', 'PD - Spinal Cord Injury', 'Assistance with Self Care Activities; Community, Social and Civic Activities', 'Yes', 'ReceivedRequested', 'Parent', null, 'ryans@email.com', '2000-02-14', 'Male', 'Email', null, 'Phone Call', 'Samuel enquired for an In Home Support that takes place 4 hours a day, 5 days a week.', 'Reviewed and discussed the process with Samuel over a phone call.', null, null, 'Gabriela Wilson', 'SuperUser'),
  ('1000011', '1000011', '2023-05-20', '2023-05-22', '4_Converted', 'Jim', 'Bo', 'DSOA - Disability Support for Older Australians', 'SD - Hearing Impairment', 'Short Term Accommodation', 'Yes', 'Received', null, null, null, null, null, 'Phone Call', null, 'Referral', null, null, null, null, 'Gabriela Wilson', 'SuperUser'),
  ('1000012', '1000012', '2023-05-21', '2023-05-23', '4_Converted', 'Bryan', 'Jackson', 'NDIS - National Disability Insurance Scheme', 'PD - Multiple Sclerosis', 'Assistance with Self Care Activities', 'Yes', 'Received', null, null, null, null, 'Male', 'Email', null, 'Website', null, null, null, null, 'Gabriela Wilson', 'SuperUser'),
  ('1000013', '1000013', '2023-05-22', '2023-05-25', '1_Initial Enquiry', 'Janice', 'Williams', 'NDIS - National Disability Insurance Scheme', 'PD - Acquired Brain Injury', 'Assistance with Self Care Activities', 'Yes', 'Requested', 'Carer', null, null, null, 'Female', 'SMS', null, 'Phone Call', null, null, null, null, 'Gabriela Wilson', 'SuperUser'),
  ('1000014', '1000014', '2023-05-24', '2023-05-29', '1_Initial Enquiry', 'Gerald', 'Anderson', 'DSOA - Disability Support for Older Australians', 'PD - Stroke', 'Assistance with Self Care Activities', 'No', 'Received', 'Guardian', null, null, null, 'Male', 'Phone Call', null, 'Referral', null, null, null, null, 'Gabriela Wilson', 'SuperUser'),
  ('1000015', '1000015', '2023-05-25', '2023-05-30', '2_To be processed', 'Jacob', 'Turner', 'NDIS - National Disability Insurance Scheme', 'PD - Absent Limb or Reduced Limb Function', 'Supported Independent Living', 'Yes', 'Received', null, null, null, null, null, 'Email', null, 'Email', null, null, null, null, 'Gabriela Wilson', 'SuperUser'),
  ('1000024', '1000024', '2024-05-20', '2024-05-27', '1_Initial Enquiry', 'Ava', 'Brown', 'NDIS - National Disability Insurance Scheme', 'ID - Autism', 'Group and Centre Based Activities', 'Yes', 'Received', 'Parent', null, null, null, 'Female', 'Email', null, 'Website', null, null, null, null, 'Gabriela Wilson', 'SuperUser')
...
values
  ('pl-ndis-2024', 'NDIS Price List 2024-25', 'NDIS', null, '2024-07-01', 'AUD', 'Isla Robinson', 'SuperUser')
on conflict (id) do update set
  name = excluded.name,
...
values
  ('loc-home', 'bp-bern', 1, 'Home', 'Home', '12 Jetty Road', 'Unit 4', null, 'Glenelg', 'SA', '5045', 'Australia', '08 8294 1100', '0412 345 678', 'Bernie@email', 'No', 'Yes', 'Yes', 'Yes', 'Yes', '2021-01-05', null, 'Wheelchair access via ramp at rear. Level entry to kitchen and bathroom.', 'Primary residence — shared with housemates.'),
  ('loc-postal', 'bp-bern', 2, 'Postal', 'Postal', 'PO Box 842', null, null, 'Adelaide', 'SA', '5000', 'Australia', null, null, null, 'Yes', 'No', 'No', 'No', 'Yes', '2021-01-05', null, null, 'Mail and official correspondence.')
on conflict (id) do update set
  client_id = excluded.client_id,
  line_no = excluded.line_no,
  name = excluded.name,
...
values
  ('ctr-1000001', '1000001', null, 'Adelaide Property Managers', 'Tenancy Agreeement', 'Rover Road Residential tenancy Agreement', 'Rover Road Residential tenancy Agreement - Demo File with DMS attachment', 'Fixed', '2022-05-07', '2022-05-08', '2025-05-07', '2024-05-25', 'ROVER-TEN-001', null, 'Isla Robinson', 'Jessica Hancock'),
  ('ctr-1000002', '1000002', 'bp-bern', 'Bernadette Rose', 'NDIS Service Agreement', 'NDIS Support Agreement - Bernadette Rose', 'Primary service agreement covering SIL, community access, and therapy supports.', 'Fixed', '2021-01-05', '2021-01-05', '2026-06-30', '2025-06-26', 'NDIS-PLAN-BERN', null, 'Isla Robinson', 'SuperUser')
on conflict (id) do update set
  document_no = excluded.document_no,
  client_id = excluded.client_id,
...
values
  ('sp-1000020', 'bp-bern', '1000020', 'Active Support Plan — completed with Bernie, signed and provided copy to her. Most recently reviewed May 2022.', '2022-05-16', '2022-05-16', true, 'My dog Kobe and my best friend Harry.', 'I like to attempt to do things for myself and will request additional support if I need it.', 'Reading and writing', 'N/A', 'Dogs, beach, dog parks', 'Heights', null, 'English', 'No', null, 'No', null, 'Yes', 'Allergic to Hay, only mild and flares up asthma. Uses a puffer as required.', 'No', null, null, null, null, 'Wake up and brush my teeth, shower. Require support. See manual handling plan', 'Attend work', 'relax, play with my dog', 'cook dinner, watch tv', 'Lunch with Harry on Sundays', true, 'Work weekdays 9-5.', true, 'Assistance to get clothes from cupboard and dress me, I will tell you what I would like to wear', 'I manage this myself, sometimes I may request assistance if my arm is tired.', 'no support required', 'no support required', null, 'I can do this myself in the shower', null, 'Yes, transfer assistance required', 'Assistance to transfer to my shower chair from wheelchair, I wash myself then need assistance back to my wheelchair', null, false, null, null, null, null, null, null, 'Yes', 'Bernie is in a wheel chair and requires support to get in and out. Manual handling plan details requirements.', 'No', 'N/A', 'love cappuccino with almond milk and favourite snack is popcorn', 'Avoids Dairy by choice', null, 'Can catch public transport provided its wheelchair accessible.', 'Manages own finances', 'manages all financials directly.', 'Isla Robinson', 'Oliver Williams')
on conflict (id) do update set
  client_id = excluded.client_id,
  document_no = excluded.document_no,
  description = excluded.description,
...
values
  ('pad-1000058', 'bp-bern', '1000058', 'Plan', 'Support Plan', null, '2023-04-01', null, 'Published', 'Rose Dash', 'sp-1000020')
on conflict (id) do update set
  client_id = excluded.client_id,
  document_no = excluded.document_no,
