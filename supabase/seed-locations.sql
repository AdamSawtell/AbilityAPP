...
values
  ('loc-glenelg-sil', 'GLEN-SIL', 'Glenelg SIL House', 'Shared independent living — 3 residents, 24/7 active overnight support.', 'SIL house', 'Active', '22 Partridge Street', '', 'Glenelg', 'SA', '5045', 'Australia', '08 8294 2200', 'glenelg.sil@abilityvua.local', 'Ramp at rear. Key safe code on file with on-call manager.', 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=640&h=400&fit=crop', 3, '2022-03-01', 'SuperUser', 'SuperUser'),
  ('loc-adelaide-hub', 'ADL-HUB', 'Adelaide Day Hub', 'Community participation and skills development — weekday program.', 'Day program', 'Active', '100 King William Street', 'Level 2', 'Adelaide', 'SA', '5000', 'Australia', '08 8123 4500', 'dayhub@abilityvua.local', 'Lift access from ground floor. Visitor sign-in at reception.', 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=640&h=400&fit=crop', 20, '2021-01-15', 'SuperUser', 'SuperUser'),
  ('loc-northern-sil', 'NTH-SIL', 'Northern SIL House', 'Four-bedroom shared living in Salisbury — active overnight and weekend support.', 'SIL house', 'Active', '45 Commercial Road', '', 'Salisbury', 'SA', '5108', 'Australia', '08 8285 3300', 'northern.sil@abilityvua.local', 'Sensor lighting at entry. Staff parking at rear.', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=640&h=400&fit=crop', 4, '2023-04-01', 'SuperUser', 'SuperUser'),
  ('loc-southern-respite', 'STH-RSP', 'Southern Respite Cottage', 'Short-term respite and STA — two guest rooms, flexible roster.', 'Respite', 'Active', '8 Jetty Road', '', 'Brighton', 'SA', '5048', 'Australia', '08 8298 7700', 'southern.respite@abilityvua.local', 'Ground-floor only. Medication lockbox in kitchen.', 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=640&h=400&fit=crop', 2, '2024-01-15', 'SuperUser', 'SuperUser'),
  ('loc-murray-bridge-day', 'MB-DAY', 'Murray Bridge Day Program', 'Regional day hub — life skills, community access, and transport.', 'Day program', 'Active', '120 Bridge Street', '', 'Murray Bridge', 'SA', '5253', 'Australia', '08 8531 4400', 'murraybridge.day@abilityvua.local', 'Bus bay at front. Evacuation assembly point is north carpark.', 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=640&h=400&fit=crop', 15, '2022-09-01', 'SuperUser', 'SuperUser')
