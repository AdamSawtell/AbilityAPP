...
export const moduleSetupGuideArticles: HelpArticle[] = [
  ...
  moduleSetupArticle(
    ...
    [
      ...
      "Create a test client: set lifecycle, add plan budget lines (manual, wizard, or CSV import on Plan budget tab), record core consents, then save and verify Overview summaries.",
