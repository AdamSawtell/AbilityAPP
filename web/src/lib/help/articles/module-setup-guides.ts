...
export const moduleSetupGuideArticles: HelpArticle[] = [
  ...
  moduleSetupArticle(
    ...
    [
      ...
      "Create a test client: set lifecycle, add plan budget lines (manual, wizard, CSV import, or gateway pull on Plan budget tab), record core consents, then save and verify Overview summaries.",
  ...
  moduleSetupArticle(
    ...
    [
      ...
      "Use Workforce planning → Fill board to assign suggested workers to vacant RoC shifts before publishing.",
