  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Can I request shifts at another location? — You can browse them with Show all available shifts but cannot submit from read-only cards. Contact rostering to express interest.",
