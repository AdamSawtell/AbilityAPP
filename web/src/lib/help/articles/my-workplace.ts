...
export const myWorkplaceArticle: HelpArticle = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "When rostering posts vacant shifts, browse cover from My workplace → Open shifts and submit a request — rostering reviews requests and assigns the selected worker. You can also mark yourself available if critical on urgent shifts, or decline shifts you do not want. By default you see shifts at your assigned locations. Use Show all available shifts to browse other sites (read-only — call rostering to apply). Track every request on My workplace → My shifts → Shift requests.",
      steps: [
        "Set your weekly pattern on My workplace → Availability so shifts can be matched to your hours.",
        "Open My workplace → Open shifts. Your assigned locations appear first — use Request shift.",
        "Optional: Show all available shifts for read-only cards at other locations.",
        "If a shift is outside your saved availability, tap Request anyway? to confirm.",
        "On critical fill shifts, you can also choose Available if critical or Decline.",
        "Withdraw a pending request from the card or from My shifts → Shift requests.",
        "When rostering approves your request, the shift appears under My shifts → Scheduled shifts.",
      ],
      relatedRoutes: ["/my/open-shifts", "/my/availability", "/my/shifts", "/rostering"],
      windowKeys: ["my-open-shifts"],
    },
    {
      id: "shift-requests",
      title: "Track shift requests",
      body: "Every open shift you request, withdraw, or mark available-if-critical appears under My workplace → My shifts → Shift requests. Status shows whether rostering is still reviewing, approved, rejected, or withdrawn. Rejection reasons appear when your organisation shares them.",
      steps: [
        "Open My workplace → My shifts → Shift requests.",
        "Review date, time, location, client, and critical fill badge on each row.",
        "Pending requests can be withdrawn until rostering decides.",
        "Approved requests move to Scheduled shifts once assigned.",
      ],
