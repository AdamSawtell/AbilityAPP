...
export const deliveryArticle: HelpArticle = {
  ...
  sections: [
    ...
    },
    {
      ...
      relatedRoutes: ["/financial-close", "/plan-reconciliation", "/claim-reconciliation", "/reports/financial-close-summary"],
      windowKeys: ["financial-close", "plan-reconciliation", "claim-reconciliation", "claims", "invoices", "timesheets"],
    },
    {
      id: "ndis-audit-pack",
