  ...
  sections: [
    ...
    },
    {
      ...
      steps: [
        ...
        "Service agreements → open record → Print agreement or Download HTML — schedule and signature render in the template.",
        "Apply participant e-sign — signed agreement HTML is saved to the document registry automatically.",
      ...
      windowKeys: ["admin-document-templates", "invoices", "service-agreements", "admin-organization"],
    },
    {
      id: "financial-close",
