...
export const incidentsArticle: HelpArticle = {
  ...
  title: "Incidents",
  summary: "Submit incidents, track NDIS reportable notifications, and maintain an audit-ready record.",
  category: "Core",
  keywords: [
    "incident",
    "report incident",
  ...
  sections: [
    {
      ...
      body: "Incidents capture what happened, who was involved, immediate actions, investigation, and NDIS Commission notifications. All incidents should be recorded — not only NDIS reportable events.",
      bullets: [
    ...
    {
      id: "who-sees-what",
      title: "Who sees which incidents",
      body: "Most frontline roles see only their own open incident reports. Managers and quality roles with Can see all incidents see the full register, summary cards, and dashboard.",
      bullets: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Reports → NDIS reportable incidents for audit exports",
        "Portal submission to the Commission is outside AbilityVua — record the reference on the incident",
      ],
      relatedRoutes: ["/incidents", "/reports"],
      windowKeys: ["incidents"],
    },
    {
      id: "client-alerts",
    ...
    },
    {
      ...
      bullets: [
        "Reports → Incident register for all incidents (roles with Can see all incidents)",
...
export const reportIncidentQuickArticle: HelpArticle = {
  ...
  summary: "Use Report incident on Home for the fastest path, or Submit incident here on the Incidents list.",
  category: "Quick tasks",
  keywords: ["report incident", "submit incident", "how do i", "NDIS", "home", "quick report", "safeguard"],
  relatedRoutes: ["/", "/incidents", "/incidents/new"],
  windowKeys: ["incidents"],
