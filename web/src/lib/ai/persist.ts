...
function clientFromRowMinimal(
  ...
  return {
    ...
    preferredCommunicationMethod: String(row.preferred_communication_method ?? ""),
    planManagementType: String(row.plan_management_type ?? ""),
    planManagerPartnerId: String(row.plan_manager_partner_id ?? ""),
    invoiceDeliveryMethod: String(row.invoice_delivery_method ?? ""),
    statementDeliveryMethod: String(row.statement_delivery_method ?? ""),
