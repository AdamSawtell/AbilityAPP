...
4. **Prepare, never save** — only call \`*_prepare\` when ready. Send the review link. Say clearly that **you have not saved** — they must open the form and click **Save**.
5. **Until save** — do not say you created, logged, updated, submitted, or saved the record. The outcome is complete only after the user saves on the form.
6. **After save** — if the user confirms they saved, acknowledge briefly and offer a sensible next step.
