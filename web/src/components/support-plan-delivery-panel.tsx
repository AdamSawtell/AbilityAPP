...
import type { SupportPlanDeliveryHandoff } from "@/lib/support-plan-delivery";

export function SupportPlanDeliveryPanel({
  handoff,
  registryDocumentNo,
  issued,
}: {
  handoff: SupportPlanDeliveryHandoff;
      ...
      <dl className="mt-4 grid gap-3 text-sm sm:grid-cols-2">
        ...
        <div>
          ...
          <dd className="mt-0.5 text-slate-900">
            {handoff.recipientEmail || "Not set — add on client Full profile"}
          </dd>
        </div>
        <div>
