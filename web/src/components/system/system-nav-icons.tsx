import type { SystemNavIconName } from "@/lib/system/nav";

export function SystemNavIcon({ name }: { name: SystemNavIconName }) {
  if (name === "home") {
    return (
    ...
    return (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M2.25 21h19.5M4.5 21V9.75A2.25 2.25 0 0 1 6.75 7.5h3.75a2.25 2.25 0 0 1 2.25 2.25V21m-9 0h9M9 21v-4.5a.75.75 0 0 1 .75-.75h4.5a.75.75 0 0 1 .75.75V21M3 21h18M9 10.5h.008v.008H9V10.5Zm3 0h.008v.008H12V10.5Zm3 0h.008v.008H15V10.5Z"
        />
      </svg>
    );
  }
