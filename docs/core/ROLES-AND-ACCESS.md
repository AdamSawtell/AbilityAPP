...
| Security settings (idle timeout) | System operator | System sign-in → System settings → Security settings |
...
| Log a maintenance request | `maintenance` or `location-maintenance` (write) | — |
