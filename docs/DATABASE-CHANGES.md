...
| `app_push_subscription` | AB-0004 Phase C — web push endpoints per device (`endpoint`, `p256dh`, `auth`, preference flags); `notify_critical_shifts`, `notify_rostering_replies` (20260701170000), `notify_shift_requests` (20260701180000) |
