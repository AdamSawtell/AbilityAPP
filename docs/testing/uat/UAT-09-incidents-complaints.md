...
| UAT-09-S-004 | Can see all incidents (role) | Support worker: My incidents only; quality manager: full register + dashboard | **Pass** — TEST-068 (2026-06-26) |
| UAT-09-S-005 | Incident dashboard | `/incidents/dashboard` (requires see-all) | **Pass** — 9 incidents; overdue alert (TEST-098) |
