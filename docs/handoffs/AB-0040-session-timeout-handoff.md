...
| Admin settings | `/admin/security` lets AbilityVua Admin set 5 to 120 minutes |
...
1. Sign in as SuperUser and open `/admin/security`.
...
| Browser smoke | PASS on localhost: `/admin/security` loads for AbilityVua Admin; setting save succeeds and restores to 15; audit footer/help visible; simulated inactivity logout redirects to login message |
